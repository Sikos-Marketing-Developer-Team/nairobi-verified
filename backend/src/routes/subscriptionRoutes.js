...
router.get('/payment-status', isAuthenticated, isMerchant, subscriptionPaymentController.checkPaymentStatus);
...
router.post('/mpesa/callback', subscriptionPaymentController.handleMpesaCallback);
