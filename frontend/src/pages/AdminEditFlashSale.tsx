...
const AdminEditFlashSale = () => {
  ...
  const fetchFlashSale = async () => {
    try {
      ...
      alert('Error loading flash sale');
      navigate('/admin/flash-sales');
    } finally {
      setLoading(false);
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        alert(data.error || 'Failed to update flash sale');
      }
    } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Flash Sale Not Found</h2>
          <Link to="/admin/flash-sales">
            <Button>Back to Flash Sales</Button>
          </Link>
        </div>
        <Footer />
      </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Update flash sale campaign details</p>
        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => updateProduct(index, 'soldQuantity', parseInt(e.target.value) || 0)}
                            placeholder="0"
                            min="0"
                          />
                        </div>
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-500 mt-1">
                                Stock: {product.stockQuantity} | Sold: {product.soldQuantity}
                              </p>
                            </div>
                          </div>
                        </div>
...
export default AdminEditFlashSale;