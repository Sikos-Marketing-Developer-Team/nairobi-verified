...
const Hero = () => {
  ...
  const handleSearch = () => {
    // Navigate to merchants or products page with search parameters
 ...
 return (
    <section className="relative bg-gradient-to-br from-orange-50 to-yellow-50 pt-32 sm:pt-48 pb-12 sm:pb-16 lg:pt-44 lg:pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-5 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            {/* Trust Indicators - Keep original desktop layout */}
            ...
            {/* CTA Buttons - Horizontal on mobile, keep desktop layout */}
          ...
          {/* Search Feature - Keep original desktop, optimize mobile */}
          <div className="relative scale-95 sm:scale-90 origin-center -ml-1 sm:-ml-2">
            <div className="bg-white/80 backdrop-blur-xl p-6 sm:p-8 rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-500 border-2 border-[#F97316]">
              {/* Header */}
              ...
              {/* Filter Options - Keep original desktop grid */}
            ...
            {/* Floating Elements - Keep original */}
            ...
            <div className="absolute -bottom-10 sm:-bottom-14 -left-3 sm:-left-5 bg-white rounded-2xl shadow-lg p-3 sm:p-4 border-l-4 border-l-green-500">
