...
import { Shield, MapPin, Star, Users, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    <section className="py-12 bg-[#F9FAFB]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h2 className="text-2xl lg:text-4xl font-bold inter text-gray-900 mb-3">
        ...
        <div className="md:hidden spaceritel-y-3">
          {features.map((feature, index) => (
            <div
              ...
              className="bg-white transition-all duration-300 ease-in-out p-3 rounded-xl"
            >
              <div 
        ...
        <div className="flex justify-center">
          <button>
            <Link
              to="/howitworks"
              className="mt-8 inline-block bg-primary text-white px-6 py-2 rounded-lg font-semibold hover:bg-primary-dark transition-colors"
            >
              Sell with Us
            </Link>
          </button>
        ...
        {/* Call to Action */}
        <div className="relative mt-6 md:mt-16 rounded-2xl overflow-hidden">
          <img
            src={nairobiImg}
            alt="Nairobi"
          ...
          <div className="relative p-4 md:p-8 lg:p-12 text-center text-white">
            <h3 className="text-lg md:text-2xl lg:text-3xl font-bold inter mb-2 md:mb-4">
              Ready to Start Shopping Safely?
            </h3>
            <p className="text-sm md:text-lg opacity-90 mb-3 md:mb-6 max-w-2xl mx-auto">
              Join thousands of satisfied customers who trust Nairobi Verified for their online shopping needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-2 justify-center">
              <Link to="/auth/register">
                <button className="bg-white text-primary px-3 py-1.5 text-xs rounded-lg font-semibold hover:bg-gray-100 transition-colors w-full sm:w-auto mb-2 sm:mb-0">
                  Create Account
                </button>
              </Link>
              <Link to="/merchants">
                <button className="border border-white text-white px-3 py-1.5 text-xs rounded-lg font-semibold hover:bg-white/10 transition-colors w-full sm:w-auto">
                  Browse Products
                </button>
              </Link>
            </div>
