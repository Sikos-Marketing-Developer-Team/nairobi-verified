...
export default function Home() {
  ...
  <section className=" md:mt-[150px] bg-orange-100 text-gray-900 py-12 px-4 sm:px-6">
    <div className="max-w-3xl mx-auto text-center">
      <h1 className="text-3xl sm:text-4xl font-bold mb-4">Welcome to Nairobi Verified</h1>
    ...
    <div className="max-w-6xl mx-auto text-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        <div className="feature-card p-6 bg-white rounded-lg shadow-md">
          <h3 className="text-xl font-semibold mb-2">Register as a Vendor</h3>
          <p className="mb-4">Easily sign up and start selling your products on Nairobi Verified.</p>
          <a href="/auth/register/merchant" className="text-[#EC5C0B] hover:underline">Create Account</a>
        </div>
        <div className="feature-card p-6 bg-white rounded-lg shadow-md">
          <h3 className="text-xl font-semibold mb-2">Browse Products</h3>
          <p className="mb-4">Explore a wide range of categories available for purchase.</p>
        ...
        <div className="feature-card p-6 bg-white rounded-lg shadow-md">
          ...
          <p className="mb-4">Vendors can manage their shop, update listings, and more.</p>
  ...
  {/* City Navigation Section */}
<section className="navigation-help py-16 px-4 bg-[#F8F8F8]">  {/* Changed color here */}
